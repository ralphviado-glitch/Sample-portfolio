<template>
	<div class="row justify-content-center align-items center py-4 py-lg-5" id="landing">
		<div class="col-10 col-md-3 p-3 py-lg-5">
			<img src="https://d2kdkfqxnvpuu9.cloudfront.net/images/thumb/47471.jpg?1319388273" class="rounded-circle border border-whote img-fluid">
			
		</div>
		<div class="col-md-7 col-lg-5 text-white py-md-5 py-lg-5">
			<h1 class="mt-2 text-center text-md-left" id="myName"> Charles Babbage</h1>
			<h3 class="my-3 text-center text-md-left" id="myTitle">Full Stact Web Developer</h3>
			<p class="text-justify landing-text">
                ...
                Babbage is considered by some to be "father of the computer".</p>
